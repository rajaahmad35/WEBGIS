...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [110.739431, -7.298386, 110.765355, -7.285538], maxZoom: 13, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:9518',
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_BidangTanah_Genengsari_1,
      colName: 'NIB',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([110.739431, -7.298386, 110.765355, -7.285538], map.getSize());
