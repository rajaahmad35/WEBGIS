...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [110.734707, -7.308605, 110.788882, -7.281754], maxZoom: 15, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:9518',
            extent: [471343.022200, 9192218.855600, 475056.052100, 9196120.446900],
            units: 'degrees'})
    })
});


map.getView().fit([110.734707, -7.308605, 110.788882, -7.281754], map.getSize());
