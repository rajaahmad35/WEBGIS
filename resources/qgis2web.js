...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [110.719815, -7.311204, 110.806472, -7.268254], maxZoom: 13, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:9518',
...
map.getView().fit([110.719815, -7.311204, 110.806472, -7.268254], map.getSize());
